...
uint measurePulseIn(uint calibration,
...
#endif
//////////////////////////////////////server////////////////////////////////////////////////////////
//global variables used to send data through TCP/IP
double IRDist = 0;
double USDist = 0;
double fusionDist = 0;
...
uint measurePulseIn(uint calibration,
	 ...
	 uint BeginTime, EndTime, lastUSTime;
